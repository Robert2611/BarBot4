...
class server(Thread):
	...
	def app(self, environ, start_response):
		...
		if environ['REQUEST_METHOD'] == 'POST':
			...
			d = urllib.parse.parse_qs(request_body.decode("utf-8"))  # turns the qs to a dict
	...
	def run(self):
		...
		self.httpd = make_server(self.ip, self.port, app, handler_class=NoLoggingWSGIRequestHandler)
