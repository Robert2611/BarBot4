...
dbfilename = os.path.join(script_dir, "..",  "bar_bot.sqlite")
...
def get_recipes():
    ...
    for recipe in recipes:
        recipe["created"] = datetime.strptime(recipe["created"],"%Y-%m-%d %H:%M:%S")
...
for recipe in get_recipes():
    ...
    recipe.pop("id")
    recipe.pop("name")
    path = os.path.join(script_dir, "..", "data", "recipes_to_import", name)
